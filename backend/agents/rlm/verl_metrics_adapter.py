...
def write_cell_metrics_from_verl(
    ...
    *,
    ...
    value, and write an ``eval_provenance.json`` sidecar recording exactly
    ...
    with NO ``success_rate`` key — never a fabricated 0.0.
    """
    ...
    metrics = {"success_rate": value, "status": "success"}
