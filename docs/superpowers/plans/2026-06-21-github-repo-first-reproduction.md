...
- Add to the commit: `docs/superpowers/specs/2026-06-21-github-repo-first-reproduction-design.md` (the approved spec, already on disk) + this plan file
...
```bash
git add CLAUDE.md system_overview.md docs/superpowers/specs/2026-06-21-github-repo-first-reproduction-design.md docs/superpowers/plans/2026-06-21-github-repo-first-reproduction.md
...
Plan complete and saved to `docs/superpowers/plans/2026-06-21-github-repo-first-reproduction.md`. Two execution options:
