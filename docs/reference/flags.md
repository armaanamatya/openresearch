...
- **Total distinct flags:** 529
- **Managed by `config.py` Settings (typed, default known):** 157
- **Ad-hoc `os.environ` reads (no central default):** 372
- **Mentioned in a `CLAUDE.md`:** 143 (27%)
...
| Flag | cfg | doc | sites | default |
|---|:--:|:--:|:--:|---|
| `OPENRESEARCH_ASSET_GCS_BUCKET` |  |  | 1 | |
...
| Flag | cfg | doc | sites | default |
|---|:--:|:--:|:--:|---|
| `OPENRESEARCH_EMIT_FIGURE_SIDECARS` |  |  |  | |
...
### `OPENRESEARCH_MINIMAL_*`

| Flag | cfg | doc | sites | default |
|---|:--:|:--:|:--:|---|
| `OPENRESEARCH_MINIMAL_VIABLE` | ✅ |  | 1 | `False` |
...
| `OPENRESEARCH_PROVIDER_PROMPTS` |  |  | 1 | `""` |
...
| `OPENRESEARCH_SDAR_REPORT_GCS` |  |  | 1 | |
...
| `OPENRESEARCH_SPEC_VALIDATOR_BACKEND` |  |  | 2 | `""` |
| `OPENRESEARCH_SPEC_VALIDATOR_BLOCK` |  |  | 1 | `""` |
| `OPENRESEARCH_SPEC_VALIDATOR_MODEL` |  |  | 3 | `""` |
| `OPENRESEARCH_SPEC_VALIDATOR_PANEL_N` |  |  | 1 | `""` |
...
### `OPENRESEARCH_VERIFY_*`

| Flag | cfg | doc | sites | default |
|---|:--:|:--:|:--:|---|
| `OPENRESEARCH_VERIFY_AGAINST_RUBRIC_TIMEOUT_S` |  |  |  | |
