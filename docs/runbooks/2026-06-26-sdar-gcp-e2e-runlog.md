...
| 2026-07-01 23:10Z | sdar_2model_a | finished | - | - | - | running | - | - | - | - | - | runs/sdar_2model_a/ | auto-pulled + logged on terminal by sdar_gcp_watch |
| 2026-07-02 03:05Z | sdar_2model_v2 | finished | - | - | - | failed | 0.5 | failed | 5.9737 | 0/2 | sigterm | runs/sdar_2model_v2/ | auto-pulled + logged on terminal by sdar_gcp_watch |
| 2026-07-02 03:07Z | sdar_2model_v2 | finished | foundry | 1.7B+3B / 3 envs | gcp/sdar-cache-a/us-central1-a/a2-ultragpu-4g(4xA100-80) | failed | 0.5 | failed | 5.9737 | 0/2 | sigterm | runs/sdar_2model_v2/ | multi-zone launcher (grabbed -a after both zones stocked out); arg-contracts off (gpt-chat-latest planning); warm cache; score 0.5 method-fidelity, reward~0 (sparse-reward wall); salvaged+stopped |
