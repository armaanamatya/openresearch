...
5. `docs/history/specs/2026-05-23-cleanup-condensation-leaderboard-design.md` — §3 locked decisions (do not relitigate), §5 phase specs, §8 acceptance.
6. `docs/history/plans/2026-05-23-phase1-rdr-lab-ui.md` — what the lab-UI gap-close work looks like if it hasn't shipped yet.
...
- [ ] The lab page handles all 3 modes (`rlm`, `rdr`, `rlm-pure`) without crashing — the canvas, popup, and rubric strip all render. If the rdr cluster-event reducer isn't wired, follow `docs/history/plans/2026-05-23-phase1-rdr-lab-ui.md`.
