...
**Reference spec:** `docs/history/specs/2026-05-23-rubric-climb-leaderboard.md` — read §3 (locked decisions) before each task; §4 has the architectural contract every task must match.
...
Spec: docs/history/specs/2026-05-23-rubric-climb-leaderboard.md §4.5"
```
...
Spec: docs/history/specs/2026-05-23-rubric-climb-leaderboard.md §4.4"
```
...
Spec: docs/history/specs/2026-05-23-rubric-climb-leaderboard.md §3 #10, §4.4"
```
...
Spec: docs/history/specs/2026-05-23-rubric-climb-leaderboard.md §3 #3, §4.2"
```
...
Spec: docs/history/specs/2026-05-23-rubric-climb-leaderboard.md §4.6"
```
...
Spec: docs/history/specs/2026-05-23-rubric-climb-leaderboard.md §5"
```
...
- Frontend: useRlmRun reducer changes — confirm previousAreas snapshot
  ...
  spec at docs/history/specs/2026-05-23-rubric-climb-leaderboard.md
  §4.2.
