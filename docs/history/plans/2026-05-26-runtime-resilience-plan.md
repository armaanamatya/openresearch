...
**Spec:** `docs/history/specs/2026-05-26-runtime-resilience-design.md`
...
```bash
git add docs/history/specs/2026-05-26-runtime-resilience-design.md \
        docs/history/plans/2026-05-26-runtime-resilience-plan.md \
        backend/agents/runtime/sdk_isolation.py \
