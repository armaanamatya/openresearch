...
leaves. See the sibling spec `.history/sdd/productization-designs.md` §B for the full module design.
...
- Companion designs already written: `.history/sdd/productization-designs.md` (§A UI-upload seam,
  §B spec-validator) and `.history/sdd/wsf-external-monitor-fix-plan.md` (the live-log monitor).
