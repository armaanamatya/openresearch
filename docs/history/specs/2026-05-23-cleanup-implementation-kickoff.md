...
_Date: 2026-05-23 · Companion to `docs/history/specs/2026-05-23-cleanup-condensation-leaderboard-design.md`. Copy §0 into the new session prompt; the rest are reference._
...
1. `docs/history/specs/2026-05-23-cleanup-condensation-leaderboard-design.md`
...
2. `git add docs/history/specs/2026-05-23-cleanup-condensation-leaderboard-design.md`
