...
Read alongside `CLAUDE.md` (§ Sandboxes, § One-GPU-per-cell execution) and `docs/history/specs/2026-05-31-oom-gpu-capacity-remediation-design.md` (the cell-matrix model this extends). Operational standup steps live in the sibling runbook `docs/runbooks/2026-06-03-azure-aks-gpu-backend-handoff.md`.
...
- `docs/history/specs/2026-05-31-oom-gpu-capacity-remediation-design.md` — the cell-matrix model (`describe_capacity`, `run_matrix`, `aggregate_cell_metrics`) this extends; `_describe_azure`'s docstring points here.
