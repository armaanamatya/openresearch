...
- **0.1** This spec saved to `docs/history/specs/2026-05-23-cleanup-condensation-leaderboard-design.md`.
...
| `docs/history/specs/2026-05-23-rubric-climb-leaderboard.md` | Leaderboard and rubric-climb spec. |
...
- All 12 `docs/history/plans/2026-05-09-*.md` (issues #17–#21 all merged).
- All 3 `docs/history/plans/2026-05-14-*.md` (rebuild + polish merged).
- All `docs/history/plans/2026-05-2[12]-*.md` (Phase 4/5/6 + infra plan + debug-harden plan + static-values plan — all delivered).
- All `docs/history/specs/2026-05-09-*.md`.
- All `docs/history/specs/2026-05-2[12]-*.md` **except**:
...
- `docs/history/specs/pr-body-*.md` (PR bodies — git history has them).
...
- `gh issue close 64 --comment "All 6 phases delivered; superseded by rdr + leaderboard work tracked in docs/history/specs/2026-05-23-cleanup-condensation-leaderboard-design.md."`
