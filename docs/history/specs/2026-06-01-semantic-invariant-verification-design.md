...
**Audience:** any worktree working on the reproduction harness — this doc is committed so it is reachable from any branch via `git show <ref>:docs/history/specs/2026-06-01-semantic-invariant-verification-design.md`.
