...
- **Read first:** this doc → the backlog (`docs/audits/2026-05-31-backend-core-opportunity-backlog.md`) → the hardening design doc (`docs/history/specs/2026-05-31-root-harness-hardening-design.md`, for the 8 invariants + the still-pending P1.5/P4–P6) → memory `[[root-harness-hardening]]`, `[[harden-borrow-provenance]]`, `[[sdar-local-baseline-status]]`.
