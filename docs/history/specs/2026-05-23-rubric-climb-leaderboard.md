...
This spec is forward-compatible with `docs/history/specs/2026-05-23-cleanup-condensation-leaderboard-design.md` (the larger Phase-4 vision) — it adds a strict subset of that surface without contradicting any locked decision there.
...
Hand off to `writing-plans` to produce the executable per-task plan (file paths, test commands, commit boundaries, TDD steps) — saved to `docs/history/plans/2026-05-23-rubric-climb-leaderboard.md`.
