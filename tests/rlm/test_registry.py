...
EXPECTED = {
    ...
    "search_literature",  # related-paper corpus lookup, OPENRESEARCH_LITERATURE_SURVEY
    "survey_related_work",  # per-paper fan-out survey, OPENRESEARCH_LITERATURE_SURVEY
}
